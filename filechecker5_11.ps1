<#
    ...
    Usage:
        powershell -File filechecker5_11.ps1
        powershell -File filechecker5_11.ps1 -DebugMode
        powershell -File filechecker5_11.ps1 -BasePath "D:\Transfer"
        powershell -File filechecker5_11.ps1 -DebugMode -SkipArchiveContents
#>
...
function Set-InitialFileAutomatic {
    ...
    $csvPath     = Join-Path $scriptDir ($stamp + "-initial.hashes.csv")
    $sidecarPath = Join-Path $scriptDir ($stamp + "-initial.hashes.csv.sha512")
    $manifestLog = Join-Path $scriptDir ($stamp + "-initial.manifest.log")
    ...
    [void]$lines.Add("")
    [void]$lines.Add(("=" * 21))
    [void]$lines.Add("Transfer files (burn with data — not self-referential):")
