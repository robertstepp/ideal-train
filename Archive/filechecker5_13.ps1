<#
    ...
    Usage:
        powershell -File filechecker5_13.ps1
        powershell -File filechecker5_13.ps1 -DebugMode
        powershell -File filechecker5_13.ps1 -BasePath "D:\Transfer"
        powershell -File filechecker5_13.ps1 -DebugMode -SkipArchiveContents
        powershell -File filechecker5_13.ps1 -ReportExtraFiles
#>
